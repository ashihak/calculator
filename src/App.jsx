  ...
  return (
    <div className="min-h-screen w-screen flex flex-col items-center gap-10 px-3 py-10">
      ...
      shadow-[0_1px_6px_5px#000000]"> 
        <input className= "bg-slate-900/80 rounded-md p-4 w-full text-2xl font-semibold
         text-white text-right tracking-wider border-2 border-pink-200 shadow-inner shadow-current"
         type="text" value={result} disabled />
         <p className="bg-slate-300 inline-block rounded-full px-3 py-1 my-2
          text-red-500 text-sm tracking-wider border border-slate-400">
          Brand Calculator</p>
